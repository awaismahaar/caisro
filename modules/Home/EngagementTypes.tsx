  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="p-8 rounded-[44px] space-y-6 bg-white border border-[#BFDBFE] box-shadow">
        ...
        <div className="p-8 rounded-[44px] space-y-6 bg-white border border-[#F1F5F9]">
      ...
      <div
        ...
        className="max-w-[1253px] h-[198px] bg-cover bg-center rounded-[44px] mt-12 flex items-center justify-center text-center text-white px-8 py-8 mx-auto"
      >
        <div className="">
          <h6 className="text-primary-blue uppercase tracking-[12%] font-medium text-[13px]">
            Strategic Notice
          </h6>
          <h2 className="font-semibold text-[42px] uppercase">
      ...
      <div
        ...
        className="after-bg-blue-lines-group relative h-[582px] bg-center rounded-[44px] bg-cover max-w-[1253px] text-white py-4 mt-12"
      >
        ...
        <div className="flex items-center justify-center h-full w-full text-center">
          <div className="relative z-10 flex items-center justify-center flex-col gap-10">
            <h2 className="font-semibold text-[42px] leading-none uppercase max-w-[600px] mx-auto">
              Ready to Access{" "}
            ...
            <p className="font-medium uppercase tracking-[26%] text-[13px] text-[#94A3B8]">
